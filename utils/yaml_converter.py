...
def fast_yaml_load(stream):
    """
    High-performance YAML loader using CSafeLoader if available,
    falling back to SafeLoader. SafeLoader and CSafeLoader provide
    the same security guarantees as safe_load but CSafeLoader is ~8-10x faster.
    """
