...
def fast_yaml_load(stream: Union[str, TextIO]) -> Any:
    """
    High-performance YAML loader that leverages CSafeLoader if available.
    Use this instead of yaml.safe_load() which is pure Python and slow.
    """
