...
# Try importing CSafeLoader for better performance
try:
...
def fast_yaml_load(stream):
    """
    Load YAML using the C parser if available, falling back to pure Python.
    Provides ~5-10x speedup over yaml.safe_load.
    """
