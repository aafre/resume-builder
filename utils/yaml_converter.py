...
def fast_yaml_load(stream):
    """
    High-performance YAML loading using CSafeLoader if available,
    falling back to SafeLoader. This provides a ~10x speedup for
    large YAML files and I/O bound tasks.
    """
    try:
