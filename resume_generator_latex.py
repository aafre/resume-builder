...
# Compiled regex patterns at the module level to avoid the overhead of repetitive
# compilation during markdown to LaTeX formatting, improving hot path performance.
...
def convert_markdown_links_to_latex(text):
    ...
    latex_text = _MARKDOWN_LINK_PATTERN.sub(r"\\href{\2}{\1}", text)
...
def convert_markdown_formatting_to_latex(text):
    ...
    for pattern, replacement in _MARKDOWN_FORMATTING_RULES:
