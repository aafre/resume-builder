...
# Define a mapping for LaTeX special characters at module level for performance
...
def _escape_latex(text):
    ...
    # Use a pre-compiled regular expression and module-level dictionary for performance
    # This approach ensures each character is handled once without recompilation overhead
