...
# Comprehensive dictionary of LaTeX special characters
# Note on markdown symbols:
...
def _escape_latex(text):
    ...
    # Use the pre-compiled regular expression to find and replace all special characters
