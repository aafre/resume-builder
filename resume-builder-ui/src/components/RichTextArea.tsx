/**
 * Rich text area component for multi-line content with WYSIWYG link editing
 * Replaces plain textareas with TipTap editor that renders links
 */

import React, { useState, useEffect } from 'react';
import { useEditor, EditorContent } from '@tiptap/react';
import { getMultiLineExtensions, markdownToHtml, htmlToMarkdown, getLinkAtPosition } from '../utils/tiptapConfig';
...
/**
 * Multi-line rich text area with clickable links and markdown mode toggle
 */
export const RichTextArea: React.FC<RichTextAreaProps> = ({
  ...
  const editor = useEditor({
    extensions: getMultiLineExtensions(placeholder, handleOpenLinkModal),
