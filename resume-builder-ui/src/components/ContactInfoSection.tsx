...
const ContactInfoSection: React.FC<ContactInfoSectionProps> = ({
  ...
  return (
    <div className="section-card">
      ...
      <p className="font-display text-base font-extralight text-stone-warm mb-6">
      ...
      <div className="border-t border-gray-200 pt-6">
        ...
        {socialLinks.length === 0 ? (
          ...
          <p className="font-display text-base font-extralight text-stone-warm mb-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {autoGeneratedIndexes.has(index) && (
                        <span
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-stone-warm"
