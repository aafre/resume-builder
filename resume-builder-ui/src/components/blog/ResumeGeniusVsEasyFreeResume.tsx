    ...
    >
      <div className="space-y-8">
        ...
        <div className="callout callout-do rounded-2xl p-6 my-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="text-center p-4 bg-white rounded-xl shadow-sm">
              ...
              <StarRating rating={3} />
              <p className="text-3xl font-bold tone-dont mt-2">$95+</p>
          ...
          <table className="w-full bg-white border border-black/[0.06] rounded-xl shadow-sm">
            ...
            <tbody className="divide-y divide-black/[0.06]">
              <tr className="callout callout-do">
                ...
                <td className="px-6 py-4 text-center tone-dont">$7.95-$39.95/month</td>
              ...
              <tr>
                ...
                <td className="px-6 py-4 text-center tone-dont">❌ Paid only</td>
                <td className="px-6 py-4 text-center">
                  <span className="inline-flex items-center px-2 py-1 rounded text-xs font-bold bg-accent text-white">EasyFreeResume</span>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="px-6 py-4 text-center tone-note">⚠️ Guides available</td>
                <td className="px-6 py-4 text-center text-accent-text">✅ Included (paid)</td>
                <td className="px-6 py-4 text-center">
              ...
              <tr className="callout callout-do">
                ...
                <td className="px-6 py-4 text-center text-accent-text">✅ Nothing to cancel</td>
                <td className="px-6 py-4 text-center tone-dont">❌ Hard to cancel</td>
                <td className="px-6 py-4 text-center">
                  <span className="inline-flex items-center px-2 py-1 rounded text-xs font-bold bg-accent text-white">EasyFreeResume</span>
                </td>
              </tr>
        ...
        <div className="callout callout-dont rounded-xl p-6 my-8">
          <h3 className="font-bold tone-dont mb-4">💰 Resume Genius 2026 Pricing</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-ink/10 tone-dont">
                <tr>
          ...
          <div className="mt-4 p-4 callout callout-dont rounded-lg">
            <p className="font-medium tone-dont">Known Issues:</p>
            <ul className="text-sm tone-dont list-disc pl-5 mt-2">
