    ...
    >
      <div className="space-y-8">
        ...
        <div className="callout callout-do rounded-2xl p-6 my-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="text-center p-4 bg-white rounded-xl shadow-sm">
              ...
              <StarRating rating={4} />
              <p className="text-3xl font-bold tone-dont mt-2">$120</p>
          ...
          <table className="w-full bg-white border border-black/[0.06] rounded-xl shadow-sm">
            ...
            <tbody className="divide-y divide-black/[0.06]">
              <tr className="callout callout-do">
                ...
                <td className="px-6 py-4 text-center tone-dont">$9.99-$24.99/month</td>
              ...
              <tr>
                ...
                <td className="px-6 py-4 text-center tone-dont">❌ Paid plans only</td>
                <td className="px-6 py-4 text-center">
                  <span className="inline-flex items-center px-2 py-1 rounded text-xs font-bold bg-accent text-white">EasyFreeResume</span>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="px-6 py-4 text-center tone-note">⚠️ Some templates</td>
                <td className="px-6 py-4 text-center">
                  <span className="inline-flex items-center px-2 py-1 rounded text-xs font-bold bg-accent text-white">EasyFreeResume</span>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="px-6 py-4 text-center tone-note">⚠️ Blog guides</td>
        ...
        <div className="callout callout-dont rounded-xl p-6 my-8">
          <h3 className="font-bold tone-dont mb-4">💰 Enhancv 2026 Pricing</h3>
