      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <div className="bg-white border border-black/[0.06] rounded-xl p-6 shadow-sm">
            ...
            <div className="bg-chalk-dark p-4 rounded-lg">
        ...
        <div className="space-y-8">
          <div className="bg-white border border-black/[0.06] rounded-xl p-8 shadow-lg">
            ...
            <div className="bg-chalk-dark p-6 rounded-lg font-mono text-sm space-y-3">
              ...
              <div>
                <p className="font-bold text-ink mb-2">SUMMARY</p>
              ...
              <div>
                <p className="font-bold text-ink mb-2">SKILLS</p>
                <p className="text-ink">
              ...
              <div>
                <p className="font-bold text-ink mb-2">PROJECTS</p>
              ...
              <div>
                <p className="font-bold text-ink mb-2">EDUCATION</p>
                <p className="text-ink">
              ...
              <div>
                <p className="font-bold text-ink mb-2">EXPERIENCE</p>
                <div className="space-y-2">
                  <p className="text-ink">
