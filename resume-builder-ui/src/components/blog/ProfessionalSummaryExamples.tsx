      ...
      <div className="space-y-8">
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-6 my-6">
          ...
          <ul className="list-disc pl-6 space-y-2 text-green-700">
            ...
            <li>
              <strong>Core Skills:</strong> 2-3 key competencies relevant to
              your target role
            </li>
            <li>
              <strong>Quantifiable Achievement:</strong> At least one specific,
              measurable result
            </li>
            <li>
            ...
            <li>
              <strong>Industry Keywords:</strong> Terms that resonate with your
              field
            </li>
          </ul>
        </div>
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-6 my-6">
          ...
          <div className="text-purple-700 space-y-3 text-lg">
            <p>
              ...
              record of <strong>[Quantifiable Achievement]</strong>. Seeking to
              leverage <strong>[Relevant Strengths]</strong> to{" "}
        ...
        <div className="grid md:grid-cols-1 gap-6 my-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              including Google Analytics, HubSpot, and social media management
              platforms. Successfully increased social media engagement by 85%
              during summer internship at tech startup. Eager to apply
              data-driven marketing strategies and fresh perspective to help
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              and Node.js, including an e-commerce platform that handles 1000+
              daily users. Strong foundation in software development lifecycle
              and agile methodologies. Seeking to contribute technical expertise
              and innovative thinking to a dynamic software development team."
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-1 gap-6 my-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              leads by 150%. Expert in marketing automation, content strategy,
              and performance analytics. Proven track record of building and
              mentoring high-performing marketing teams while collaborating
              cross-functionally to achieve aggressive growth targets."
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              reduced system latency by 40%. Proficient in React, Node.js,
              Python, and AWS cloud infrastructure. Strong advocate for clean
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              accuracy by 25% and identified $1.2M in cost-saving opportunities.
              Advanced proficiency in Excel, SQL, and Tableau for data
              visualization. Strong communicator who translates complex
              financial data into actionable insights for executive leadership."
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-1 gap-6 my-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              product portfolios with 2M+ active users. Expert in agile
              methodology, user experience design, and data-driven product
              strategy. Proven ability to align cross-functional teams and
              stakeholders around product vision while delivering measurable
              business impact in competitive markets."
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              metrics across 5 facilities. Expert in lean manufacturing, supply
              chain optimization, and change management. Strong track record of
              scaling operations during rapid growth phases and implementing
              technology solutions that drive sustainable competitive
              advantages."
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              expanding team from 10 to 45 sales professionals. Expert in
              enterprise sales, channel partnerships, and sales operations.
              Proven ability to develop go-to-market strategies, penetrate new
              markets, and build lasting customer relationships that drive
              sustainable growth."
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-1 gap-6 my-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              through implementing CI/CD pipelines and monitoring solutions.
              Proficient in Docker, Kubernetes, AWS, and Infrastructure as Code.
              Passionate about building reliable, scalable systems that enable
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              retention by 20% and reduced fraud detection false positives by
              35%. Expert in Python, R, SQL, and cloud-based ML platforms.
              Strong communicator who collaborates effectively with stakeholders
              to translate data insights into strategic business decisions."
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-1 gap-6 my-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              interdisciplinary collaboration. Consistently achieved 95%+
              patient satisfaction scores and served as charge nurse for 30-bed
              unit. Committed to evidence-based practice and continuous
              professional development to deliver optimal patient outcomes."
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              efficiency by 25% through process improvement initiatives. Expert
              in healthcare compliance, budget management, and staff
              development. Strong leader who builds collaborative relationships
              with medical staff, patients, and community stakeholders."
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-1 gap-6 my-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              exceeding benchmark by 150 basis points. Expert in comprehensive
              financial planning, risk management, and estate planning
              strategies. Strong relationship builder who provides personalized
              service and education to help clients make informed investment
              decisions."
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-gray-700 italic leading-relaxed">
              ...
              days and improved reporting accuracy. Expert in financial
              analysis, budgeting, and compliance with SOX requirements. Proven
              track record of building finance teams and establishing robust
              internal controls that support business growth."
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl p-8 my-12">
          ...
          <ol className="list-decimal pl-6 space-y-3 text-lg">
            <li>
              Identify 3-5 target job descriptions and analyze common
              requirements
            </li>
            <li>List your top achievements with quantifiable results</li>
            <li>Choose 2-3 core skills most relevant to your target roles</li>
            <li>Write 3 different summary versions using our templates</li>
            <li>Test and refine based on application responses and feedback</li>
            <li>Update your summary regularly as you gain new achievements</li>
          </ol>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 my-8">
          <div className="bg-green-50 border border-green-200 rounded-xl p-6">
            ...
            <ul className="list-disc pl-6 space-y-2 text-green-700 text-sm">
              ...
              <li>Preferred by most employers and recruiters</li>
              <li>Works for all experience levels</li>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
            ...
            <ul className="list-disc pl-6 space-y-2 text-yellow-700 text-sm">
              ...
              <li>May be appropriate for career changers</li>
              <li>Can work for very entry-level positions</li>
              <li>Generally less preferred by recruiters</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-6 my-6">
          ...
          <ul className="list-disc pl-6 space-y-2 text-purple-700">
            ...
            <li>
              <strong>Include industry keywords:</strong> Technical skills,
              certifications, and methodologies
            </li>
            <li>
              <strong>Balance keywords naturally:</strong> Integrate them
              smoothly into readable sentences
            </li>
            <li>
              <strong>Use both acronyms and full terms:</strong> "Search Engine
              Optimization (SEO)" covers more bases
            </li>
            <li>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 mt-8">
          ...
          <p className="text-yellow-700">
            ...
            management and ongoing professional growth.
          </p>
        </div>
        ...
        <p className="text-lg leading-relaxed text-gray-700">
          ...
          encourage recruiters to continue reading. Use the examples and
          templates in this guide as starting points, but always customize your
