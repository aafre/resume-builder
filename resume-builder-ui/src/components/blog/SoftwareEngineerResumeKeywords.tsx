...
export default function SoftwareEngineerResumeKeywords() {
  return (
    <BlogLayout
      ...
      <div className="space-y-8">
          ...
          <div className="bg-accent/[0.06] border border-accent/20 rounded-xl p-6">
            ...
            <div className="bg-white p-4 rounded-lg text-sm">
              ...
              <div className="text-ink/60 space-y-1">
                ...
                <p><strong>Cloud Platforms:</strong> AWS (EC2, S3, Lambda), Docker, Kubernetes</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-accent/[0.06] border border-accent/20 rounded-xl p-6">
            ...
            <div className="bg-white p-4 rounded-lg text-sm text-ink/80">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Include experience level for key technologies</li>
                <li>Mention relevant certifications or training</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="my-12 bg-ink text-white rounded-2xl shadow-xl p-5 sm:p-8 md:p-12 text-center">
          ...
          <p className="text-xl mb-6 opacity-90">
            Use these keywords with our ATS-friendly templates designed for
            software engineers
          </p>
          <a
            href="/templates"
        ...
        <div className="bg-accent/[0.06] border border-accent/20 rounded-xl p-6">
          ...
          <ol className="list-decimal pl-6 space-y-2 text-ink/80">
            ...
            <li>
              Research 3-5 job postings in your target role and note recurring keywords
            </li>
            <li>
              Create a master skills inventory with proficiency levels for each technology
            </li>
            <li>
              Rewrite your experience bullets to naturally incorporate relevant keywords
            </li>
            <li>
              Test your resume with ATS-checking tools to ensure keyword optimization
            </li>
            <li>
              Update your LinkedIn profile to match your resume keywords for consistency
            </li>
          </ol>
        </div>
        ...
        <p className="text-lg leading-relaxed text-ink/60 mt-8">
          ...
          The goal isn't keyword stuffing — it's clearly communicating your
          technical expertise using the exact terms recruiters search for.
        </p>
