  ...
  return (
    <button
      ...
      className={`
        ...
        text-stone-warm text-sm font-medium
        bg-transparent
        ...
        disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:border-gray-300 disabled:hover:text-stone-warm disabled:hover:bg-transparent
        ${className}
      `.trim().replace(/\s+/g, ' ')}
      {...props}
    >
