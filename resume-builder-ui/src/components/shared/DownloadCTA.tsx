...
export default function DownloadCTA({
  ...
  const buttonClassName = "inline-block bg-white text-accent px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300";
  ...
  return (
    <RevealSection variant="scale-in">
      <div
        className={`my-16 bg-ink text-white rounded-2xl shadow-xl p-8 md:p-12 text-center ${className}`}
      >
