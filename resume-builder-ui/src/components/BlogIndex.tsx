...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    description: 'Craft a compelling professional summary that grabs attention with these proven examples and templates.',
  ...
  },
  {
    ...
    description: 'Navigate career transitions with a resume that positions your transferable skills for your new industry.',
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Expert advice, tips, and strategies to help you create outstanding resumes, 
            navigate your career, and land your dream job.
          </p>
        </header>
        ...
        <section className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <p className="text-xl mb-6 opacity-90">
              Create a professional resume in minutes with our free resume builder
            </p>
            <Link 
              to="/templates"
