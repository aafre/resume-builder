        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link
                to="/resume-examples"
                onClick={scrollToTop('/resume-examples')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors duration-200 text-sm"
              >
                All Examples
              </Link>
              <Link
                ...
                onClick={scrollToTop('/resume-examples/software-engineer')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors duration-200 text-sm"
              >
                Software Engineer
              </Link>
              <Link
                ...
                onClick={scrollToTop('/resume-examples/project-manager')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors duration-200 text-sm"
              >
                Project Manager
              </Link>
              <Link
                to="/resume-examples/customer-service"
                onClick={scrollToTop('/resume-examples/customer-service')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors duration-200 text-sm"
              >
                Customer Service
              </Link>
              <Link
                to="/resume-examples/registered-nurse"
                onClick={scrollToTop('/resume-examples/registered-nurse')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors duration-200 text-sm"
              >
                Registered Nurse
              </Link>
