...
export default function ResumeKeywordsHub() {
  ...
  return (
    <SEOPageLayout seoConfig={config.seo} schemas={schemas}>
      ...
      <RevealSection>
        <div className="mb-16 max-w-4xl mx-auto" id="popular-keywords" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 500px' }}>
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-premium border border-black/[0.06]">
      ...
      <RevealSection>
        <div className="mb-16 max-w-4xl mx-auto" id="quick-reference" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 800px' }}>
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-premium border border-black/[0.06]">
