...
const ExperienceItem: React.FC<ExperienceItemProps> = React.memo(({
  ...
  const handleUpdateField = useCallback((field: keyof ExperienceItemData, value: string | string[]) => {
  ...
  const handleReorderDescription = useCallback((oldDescIndex: number, newDescIndex: number) => {
    const reorderedDescriptions = arrayMove(experience.description, oldDescIndex, newDescIndex);
    handleUpdateField("description", reorderedDescriptions);
  }, [experience.description, handleUpdateField]);
  ...
  const handleUpdateDescription = useCallback((descIndex: number, value: string) => {
    ...
    handleUpdateField("description", updatedDescriptions);
  }, [experience.description, handleUpdateField]);

  const handleDeleteDescription = useCallback((descIndex: number) => {
    const updatedDescriptions = [...experience.description];
  ...
  const handleAddDescription = useCallback(() => {
    handleUpdateField("description", [...experience.description, ""]);
  }, [experience.description, handleUpdateField]);
