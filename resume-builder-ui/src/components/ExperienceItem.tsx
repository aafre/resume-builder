...
interface ExperienceItemProps {
  ...
  index: number;
  onUpdate: (index: number, updatedExperience: ExperienceItemType) => void;
  onDelete: (index: number) => void;
  supportsIcons?: boolean;
  iconRegistry?: IconRegistryMethods;
  sectionName: string; // Needed for unique IDs in DnD
}
...
const ExperienceItem = memo(({
  ...
  const handleUpdateField = (field: keyof ExperienceItemType, value: any) => {
    onUpdate(index, {
      ...experience,
      [field]: value,
    });
        ...
        {supportsIcons && iconRegistry && (
          <div className="mb-4">
            <IconManager
              ...
              onChange={(filename, file) => handleIconChange(filename, file)}
