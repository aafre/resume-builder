...
const Editor: React.FC = () => {
  ...
  const [isLinkedInTextAutoGenerated, setIsLinkedInTextAutoGenerated] =
    useState(false);
  ...
  const generateLinkedInDisplayText = useCallback(
    async (linkedinUrl: string) => {
  ...
  const debouncedGenerateLinkedInDisplay = useCallback(
    (linkedinUrl: string) => {
  ...
  const validateLinkedInUrl = (url: string): boolean => {
    ...
    if (
      ...
      (urlLower.endsWith("linkedin.com") || urlLower.endsWith("linkedin.com/"))
    ) {
      setLinkedinUrlError(
        "Please enter a complete LinkedIn profile URL (e.g., linkedin.com/in/yourname)"
      );
      return false;
    }
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleLinkedInDisplayChange(e.target.value)
                    }
                ...
                <p className="text-gray-500 text-xs mt-1">
                  We'll suggest professional text, but you can customize it
                  however you like
                </p>
              </div>
            </div>
              ...
              if (section.name === "Experience") {
                return (
                  <DragHandle
                    ...
                    <div
                      ref={
                        index === sections.length - 1 ? newSectionRef : null
                      }>
                      <ExperienceSection
