...
import EducationItem, { EducationItemData, IconRegistryMethods } from "./EducationItem";
...
const EducationSection: React.FC<EducationSectionProps> = ({
  ...
  // Refs for stable callbacks to prevent re-renders of EducationItem
  ...
  const handleIconChangeStable = useCallback((
    index: number,
              ...
              {education.map((item, index) => (
                <SortableItem key={itemIds[index]} id={itemIds[index]}>
                  <EducationItem
                    item={item}
                    index={index}
                    onUpdate={handleUpdateItemStable}
