...
import ExperienceItem, { ExperienceItemData, EditableExperienceField } from "./ExperienceItem";
...
const ExperienceSection: React.FC<ExperienceSectionProps> = ({
  ...
  // Refs to hold latest state/handlers for stable callbacks
  ...
  // Stable handler for item updates (prevents list re-renders)
  const handleUpdateItem = useCallback(
    (
      index: number,
      field: EditableExperienceField,
      value: ExperienceItemData[EditableExperienceField]
    ) => {
  ...
  const handleIconChange = useCallback(
    (index: number, filename: string | null, file: File | null) => {
      const currentExperiences = [...experiencesRef.current];
      currentExperiences[index] = {
        ...currentExperiences[index],
        icon: filename,
