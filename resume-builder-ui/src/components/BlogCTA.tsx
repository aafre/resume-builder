                ...
                <div className="flex-1">
                  ...
                  {content.primaryAction.internal ? (
                    <Link
                      ...
                      className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transform hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
                ...
                <div className="flex-1">
                  ...
                  {content.secondaryAction.internal ? (
                    <Link
                      ...
                      className="inline-flex items-center px-6 py-3 bg-purple-600 text-white font-semibold rounded-xl hover:bg-purple-700 transform hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
