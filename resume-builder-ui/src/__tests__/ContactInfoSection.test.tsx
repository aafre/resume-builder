...
describe("ContactInfoSection", { timeout: 5000 }, () => {
  ...
  it("displays auto-generated indicator (magic wand) for auto-generated display text", () => {
    ...
    // The marker is an icon, not an emoji glyph: emoji standing in for an icon
    // system is a design-system violation, so assert the accessible name and
    // the rendered icon rather than a literal character.
    const autoGenerated = screen.getByLabelText(/auto-generated/i);
    expect(autoGenerated).toBeInTheDocument();
    expect(autoGenerated.querySelector("svg")).toBeInTheDocument();
  });
