...
describe('LinkInsertionModal', () => {
  ...
  it('should have proper role and aria attributes', () => {
    ...
    // The heading id is generated by useId now (a hard-coded id would collide
    // if two dialogs mounted together), so assert the resolved accessible
    // name rather than the id string.
    expect(dialog).toHaveAccessibleName('Insert Link');
  });
